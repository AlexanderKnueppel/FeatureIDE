...
public class Configuration {
	public static String keyPath = "/mnt/54AFF99F466B2AED/Informatik/Masterarbeit/FeatureIDE-Alex/FeatureIDE/plugins/de.ovgu.featureide.core.featurehouse.proofautomation/lib/key-2.9-exe.jar"; //contains the key binary path (usually system\binary)
